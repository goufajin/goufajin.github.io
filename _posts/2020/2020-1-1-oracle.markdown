...
案例：
有如下表，要求就裱中所有�]有及格的成�，在每次增�L0.1的基�A上，使他����好及格:
...
4,isnull( check_expression , replacement_value )如果check_expression�榭眨��t返回replacement_value的值，不�榭眨�就返回check_expression字符操作类 
